...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sat May 6 08:55:33 2017
...
CC            = gcc
CXX           = g++
DEFINES       = -DQWT_DLL -DQT_WEBKIT_LIB -DQT_SVG_LIB -DQT_SQL_LIB -DQT_OPENGL_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -m64 -pipe -g $(shell dpkg-buildflags --get CFLAGS) -D_FORTIFY_SOURCE=2 -Wall -W -D_REENTRANT $(DEFINES)
CXXFLAGS      = -m64 -pipe -g $(shell dpkg-buildflags --get CXXFLAGS) -D_FORTIFY_SOURCE=2 -Wall -W -D_REENTRANT $(DEFINES)
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtNetwork -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtOpenGL -I/usr/include/qt4/QtSql -I/usr/include/qt4/QtSvg -I/usr/include/qt4/QtWebKit -I/usr/include/qt4 -I/home/ajn/qwt-6.0.2/include -I/usr/include/qwt -I/usr/X11R6/include -I. -I.
LINK          = g++
LFLAGS        = -m64 $(shell dpkg-buildflags --get LDFLAGS)
LIBS          = $(SUBLIBS)  -L/lib -L/usr/lib/x86_64-linux-gnu -L/usr/X11R6/lib64 -L/home/ajn/qwt-6.0.2/lib -lqwt -lQtWebKit -lQtSvg -lQtSql -lQtOpenGL -lQtGui -lQtNetwork -lQtCore -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		...
		calcavgannualgrowthrateequity.cpp moc_WebBrowserTab.cpp \
		moc_tableTab.cpp \
		moc_tabdialog.cpp \
		...
		moc_video.cpp \
		moc_calcavgannualgrowthrateequity.cpp \
		qrc_resourcedb.cpp
OBJECTS       = main.o \
		WebBrowserTab.o \
		util.o \
		...
		stockAnalysisTab.o \
		extendedLineEdit.o \
		createstockanalysishtmlpage.o \
		dbSubHndl.o \
		subanalysisdisplaygraphdata.o \
		video.o \
		readexercisefile.o \
		dbvideohelp.o \
		parseomxallfinancelinkdata.o \
		parseomxbridgedata.o \
		calcavgannualgrowthrateequity.o \
		moc_WebBrowserTab.o \
		moc_tableTab.o \
		moc_tabdialog.o \
		...
		moc_video.o \
		moc_calcavgannualgrowthrateequity.o \
		qrc_resourcedb.o
...
$(TARGET): ui_WebBrowserTab.h ui_tableTab.h ui_selIndicatorsDlg.h ui_jackStock.h ui_TADlg.h ui_portfolio.h ui_taAnalysis.h ui_efficientPortfolio.h ui_efficentbargraphdlg.h ui_importdata.h ui_tabhelp.h ui_fatab.h ui_graphtab.h ui_leastsquarestadlg.h ui_keyIndicators_3.h ui_adminmyportfolio.h ui_stockanalysistab.h ui_video.h ui_calcavgannualgrowthrateequity.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/JackStock1.0.0/ && $(COPY_FILE) --parents WebBrowserTab.h util.h tableTab.h tabdialog.h selIndicatorsDlg.h parseYieldData.h parsePriceData.h parseKeyNumberData.h myOs.h jackStock.h httpwindow.h httpdownloader.h inc/guiUtil/guiUtils.h extendedTable.h dbHndl.h common.h extendedQwtPlot.h TADlg.h findfiledialog.h assistant.h textedit.h parsesnapshotdata.h debug.h graphtab.h stockPlotUtil.h yahooStockPlotUtil.h parseTaData.h parseavanzadata.h portfolio.h fifo.h sublist.h importYahooTaData.h commonFinance.h canvaspicker.h matrix.h taAnalysis.h efficientPortfolio.h efficentbargraphdlg.h threadcalcefficentfront.h nordnetparsecompanyid.h parsekeytabridgedata.h importdata.h parsecompanyeconomyinfo.h taskQue.h linkedList.h tabhelp.h parsecompdescription.h fatab.h inc/guiUtil/guiFinanceColor.h inc/guiUtil/myLineEdit.h inc/guiUtil/guiFinanceCtrls.h inc/guiUtil/myTreeWidget.h inc/TaBuySellIdicator/taBuySellIdicator.h leastSquareStaDlg.h inc/myOs/mutex.h inc/myOs/semaphore.h inc/myOs/mytaskQue.h inc/TaBuySellIdicator/taBuySellTask.h inc/GetHtmlPage/getYahooKeyStatistics.h keyIndicators_3.h adminMyPortFolio.h stockAnalysisTab.h extendedLineEdit.h createstockanalysishtmlpage.h subanalysisdisplaygraphdata.h video.h readexercisefile.h parseomxallfinancelinkdata.h parseomxbridgedata.h calcavgannualgrowthrateequity.h .tmp/JackStock1.0.0/ && $(COPY_FILE) --parents database/resourcedb.qrc .tmp/JackStock1.0.0/ && $(COPY_FILE) --parents main.cpp WebBrowserTab.cpp util.cpp tableTab.cpp tabdialog.cpp selIndicatorsDlg.cpp parseYieldData.cpp parsePriceData.cpp parseKeyNumberData.cpp myOs.cpp jackStock.cpp httpwindow.cpp httpdownloader.cpp src/guiUtil/guiUtils.cpp extendedTable.cpp dbHndl.cpp extendedQwtPlot.cpp TADlg.cpp assistant.cpp findfiledialog.cpp textedit.cpp parsesnapshotdata.cpp debug.cpp graphtab.cpp stockPlotUtil.cpp yahooStockPlotUtil.cpp parseavanzadata.cpp portfolio.cpp parseTaData.cpp fifo.cpp importYahooTaData.cpp canvaspicker.cpp matrix.cpp taAnalysis.cpp efficientPortfolio.cpp efficentbargraphdlg.cpp threadcalcefficentfront.cpp nordnetparsecompanyid.cpp parsekeytabridgedata.cpp importdata.cpp parsecompanyeconomyinfo.cpp taskQue.cpp linkedList.cpp tabhelp.cpp parsecompdescription.cpp fatab.cpp src/guiUtil/guiFinanceColor.cpp src/guiUtil/guiFinanceCtrls.cpp src/guiUtil/myTreeWidget.cpp src/guiUtil/myLineEdit.cpp src/TaBuySellIdicator/taBuySellIdicator.cpp leastSquareStaDlg.cpp src/myOS/mutex.cpp src/myOS/semaphore.cpp src/myOS/mytaskQue.cpp src/TaBuySellIdicator/taBuySellTask.cpp src/GetHtmlPage/getYahooKeyStatistics.cpp adminMyPortFolio.cpp keyIndicators_3.cpp stockAnalysisTab.cpp extendedLineEdit.cpp createstockanalysishtmlpage.cpp dbSubHndl.cpp subanalysisdisplaygraphdata.cpp video.cpp readexercisefile.cpp dbvideohelp.cpp parseomxallfinancelinkdata.cpp parseomxbridgedata.cpp calcavgannualgrowthrateequity.cpp .tmp/JackStock1.0.0/ && $(COPY_FILE) --parents WebBrowserTab.ui tableTab.ui selIndicatorsDlg.ui jackStock.ui TADlg.ui portfolio.ui taAnalysis.ui efficientPortfolio.ui efficentbargraphdlg.ui importdata.ui tabhelp.ui fatab.ui graphtab.ui leastsquarestadlg.ui keyIndicators_3.ui adminmyportfolio.ui stockanalysistab.ui video.ui calcavgannualgrowthrateequity.ui .tmp/JackStock1.0.0/ && (cd `dirname .tmp/JackStock1.0.0` && $(TAR) JackStock1.0.0.tar JackStock1.0.0 && $(COMPRESS) JackStock1.0.0.tar) && $(MOVE) `dirname .tmp/JackStock1.0.0`/JackStock1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/JackStock1.0.0
...
compiler_moc_header_make_all: moc_WebBrowserTab.cpp moc_tableTab.cpp moc_tabdialog.cpp moc_selIndicatorsDlg.cpp moc_jackStock.cpp moc_httpwindow.cpp moc_httpdownloader.cpp moc_TADlg.cpp moc_findfiledialog.cpp moc_textedit.cpp moc_parsesnapshotdata.cpp moc_graphtab.cpp moc_portfolio.cpp moc_importYahooTaData.cpp moc_canvaspicker.cpp moc_taAnalysis.cpp moc_efficientPortfolio.cpp moc_efficentbargraphdlg.cpp moc_nordnetparsecompanyid.cpp moc_importdata.cpp moc_parsecompanyeconomyinfo.cpp moc_tabhelp.cpp moc_fatab.cpp moc_myLineEdit.cpp moc_guiFinanceCtrls.cpp moc_myTreeWidget.cpp moc_leastSquareStaDlg.cpp moc_taBuySellTask.cpp moc_getYahooKeyStatistics.cpp moc_keyIndicators_3.cpp moc_adminMyPortFolio.cpp moc_stockAnalysisTab.cpp moc_video.cpp moc_calcavgannualgrowthrateequity.cpp
...
moc_stockAnalysisTab.cpp: inc/guiUtil/guiFinanceCtrls.h \
		inc/guiUtil/guiFinanceColor.h \
		inc/guiUtil/myLineEdit.h \
		inc/guiUtil/myTreeWidget.h \
		dbHndl.h \
...
moc_calcavgannualgrowthrateequity.cpp: calcavgannualgrowthrateequity.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) calcavgannualgrowthrateequity.h -o moc_calcavgannualgrowthrateequity.cpp

compiler_rcc_make_all: qrc_resourcedb.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_resourcedb.cpp
qrc_resourcedb.cpp: database/resourcedb.qrc \
		database/AnalysDoc/Investeringskriterier.html \
		database/AnalysDoc/images/BestRiskReturnLageCap.png
	/usr/lib/x86_64-linux-gnu/qt4/bin/rcc -name resourcedb database/resourcedb.qrc -o qrc_resourcedb.cpp
...
compiler_uic_make_all: ui_WebBrowserTab.h ui_tableTab.h ui_selIndicatorsDlg.h ui_jackStock.h ui_TADlg.h ui_portfolio.h ui_taAnalysis.h ui_efficientPortfolio.h ui_efficentbargraphdlg.h ui_importdata.h ui_tabhelp.h ui_fatab.h ui_graphtab.h ui_leastsquarestadlg.h ui_keyIndicators_3.h ui_adminmyportfolio.h ui_stockanalysistab.h ui_video.h ui_calcavgannualgrowthrateequity.h
compiler_uic_clean:
	-$(DEL_FILE) ui_WebBrowserTab.h ui_tableTab.h ui_selIndicatorsDlg.h ui_jackStock.h ui_TADlg.h ui_portfolio.h ui_taAnalysis.h ui_efficientPortfolio.h ui_efficentbargraphdlg.h ui_importdata.h ui_tabhelp.h ui_fatab.h ui_graphtab.h ui_leastsquarestadlg.h ui_keyIndicators_3.h ui_adminmyportfolio.h ui_stockanalysistab.h ui_video.h ui_calcavgannualgrowthrateequity.h
...
ui_video.h: video.ui
	/usr/lib/x86_64-linux-gnu/qt4/bin/uic video.ui -o ui_video.h

ui_calcavgannualgrowthrateequity.h: calcavgannualgrowthrateequity.ui
	/usr/lib/x86_64-linux-gnu/qt4/bin/uic calcavgannualgrowthrateequity.ui -o ui_calcavgannualgrowthrateequity.h
...
extendedLineEdit.o: extendedLineEdit.cpp extendedLineEdit.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o extendedLineEdit.o extendedLineEdit.cpp

createstockanalysishtmlpage.o: createstockanalysishtmlpage.cpp createstockanalysishtmlpage.h \
		dbHndl.h \
		stockPlotUtil.h \
		yahooStockPlotUtil.h \
		extendedQwtPlot.h \
		...
		inc/guiUtil/myLineEdit.h \
		inc/guiUtil/myTreeWidget.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o createstockanalysishtmlpage.o createstockanalysishtmlpage.cpp

dbSubHndl.o: dbSubHndl.cpp dbHndl.h \
		stockPlotUtil.h \
		yahooStockPlotUtil.h \
		extendedQwtPlot.h \
		fifo.h \
		...
		inc/guiUtil/myLineEdit.h \
		inc/guiUtil/myTreeWidget.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o dbSubHndl.o dbSubHndl.cpp

subanalysisdisplaygraphdata.o: subanalysisdisplaygraphdata.cpp subanalysisdisplaygraphdata.h \
		dbHndl.h \
		stockPlotUtil.h \
		yahooStockPlotUtil.h \
		extendedQwtPlot.h \
		...
		inc/guiUtil/myLineEdit.h \
		inc/guiUtil/myTreeWidget.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o subanalysisdisplaygraphdata.o subanalysisdisplaygraphdata.cpp
...
readexercisefile.o: readexercisefile.cpp readexercisefile.h \
		common.h \
		dbHndl.h \
		stockPlotUtil.h \
		yahooStockPlotUtil.h \
		...
		inc/guiUtil/myLineEdit.h \
		inc/guiUtil/myTreeWidget.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o readexercisefile.o readexercisefile.cpp

dbvideohelp.o: dbvideohelp.cpp dbHndl.h \
		stockPlotUtil.h \
		yahooStockPlotUtil.h \
		extendedQwtPlot.h \
		fifo.h \
		...
		inc/guiUtil/myLineEdit.h \
		inc/guiUtil/myTreeWidget.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o dbvideohelp.o dbvideohelp.cpp

parseomxallfinancelinkdata.o: parseomxallfinancelinkdata.cpp parseomxallfinancelinkdata.h \
		parseomxbridgedata.h \
		util.h \
		dbHndl.h \
		stockPlotUtil.h \
		...
		inc/guiUtil/myLineEdit.h \
		inc/guiUtil/myTreeWidget.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o parseomxallfinancelinkdata.o parseomxallfinancelinkdata.cpp

parseomxbridgedata.o: parseomxbridgedata.cpp parseomxbridgedata.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o parseomxbridgedata.o parseomxbridgedata.cpp

calcavgannualgrowthrateequity.o: calcavgannualgrowthrateequity.cpp calcavgannualgrowthrateequity.h \
		ui_calcavgannualgrowthrateequity.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o calcavgannualgrowthrateequity.o calcavgannualgrowthrateequity.cpp
...
moc_calcavgannualgrowthrateequity.o: moc_calcavgannualgrowthrateequity.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_calcavgannualgrowthrateequity.o moc_calcavgannualgrowthrateequity.cpp

qrc_resourcedb.o: qrc_resourcedb.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_resourcedb.o qrc_resourcedb.cpp
