...
# Generated by qmake (2.01a) (Qt 4.8.7) on: sön okt 23 15:19:22 2016
...
SOURCES       = main.cpp \
		...
		createstockanalysishtmlpage.cpp moc_WebBrowserTab.cpp \
		moc_tableTab.cpp \
		moc_tabdialog.cpp \
