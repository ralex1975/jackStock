/********************************************************************************
** Form generated from reading UI file 'graphTable1Tab.ui'
**
** Created: Sun Mar 10 22:43:32 2013
**      by: Qt User Interface Compiler version 4.8.3
**
** WARNING! All changes made in this file will be lost when recompiling UI file!
********************************************************************************/

#ifndef UI_GRAPHTABLE1TAB_H
#define UI_GRAPHTABLE1TAB_H
...
public:
    ...
    void setupUi(QDialog *GraphTable1Tab)
    {
        if (GraphTable1Tab->objectName().isEmpty())
            GraphTable1Tab->setObjectName(QString::fromUtf8("GraphTable1Tab"));
        GraphTable1Tab->resize(1296, 622);
        tabWidget = new QTabWidget(GraphTable1Tab);
        tabWidget->setObjectName(QString::fromUtf8("tabWidget"));
        tabWidget->setGeometry(QRect(10, 0, 271, 601));
        tab = new QWidget();
        ...
        qwtPlot = new QwtPlot(GraphTable1Tab);
        qwtPlot->setObjectName(QString::fromUtf8("qwtPlot"));
        qwtPlot->setGeometry(QRect(300, 40, 961, 288));
        tableView = new QTableView(GraphTable1Tab);
        tableView->setObjectName(QString::fromUtf8("tableView"));
        tableView->setGeometry(QRect(300, 340, 961, 277));

        retranslateUi(GraphTable1Tab);

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(GraphTable1Tab);
    } // setupUi

    void retranslateUi(QDialog *GraphTable1Tab)
    {
        GraphTable1Tab->setWindowTitle(QApplication::translate("GraphTable1Tab", "Dialog", 0, QApplication::UnicodeUTF8));
        FilterButton->setText(QApplication::translate("GraphTable1Tab", "Filtrera", 0, QApplication::UnicodeUTF8));
        getWebDataButton->setText(QApplication::translate("GraphTable1Tab", "H\303\244mta", 0, QApplication::UnicodeUTF8));
        ShowLatestButton->setText(QApplication::translate("GraphTable1Tab", "Visa", 0, QApplication::UnicodeUTF8));
        largeCapCheckBox->setText(QApplication::translate("GraphTable1Tab", "Large Cap", 0, QApplication::UnicodeUTF8));
        midCapCheckBox->setText(QApplication::translate("GraphTable1Tab", "Mid Cap", 0, QApplication::UnicodeUTF8));
        smallCapCheckBox->setText(QApplication::translate("GraphTable1Tab", "Small Cap", 0, QApplication::UnicodeUTF8));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("GraphTable1Tab", "Tab 1", 0, QApplication::UnicodeUTF8));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("GraphTable1Tab", "Tab 2", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class GraphTable1Tab: public Ui_GraphTable1Tab {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_GRAPHTABLE1TAB_H
