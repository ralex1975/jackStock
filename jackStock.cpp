...
char colorArr[CUtil::MAX_NOF_RGB_COLORS][80] = {"BLACK",
                     "RED_1",
                     "ORANGE_1",
                     "YELLOW_1",
                     "GREEN_1",
...
// Not used default dialog in a project
CJackStock::CJackStock(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::CJackStock)
{
    CUtil cu;
    ...
    for(int i = 0; i < CUtil::MAX_NOF_RGB_COLORS; i++)
    {
        ...
        item->setBackground(1, cu.getQColor((CUtil::ColorRgb_ET) i));
        item->setText(1, " ");
...
CJackStock::~CJackStock()
{
    delete ui;
}

void CJackStock::on_pushButton_clicked()
{
...
void CJackStock::on_pushButton_2_clicked()
{
...
void CJackStock::on_pushButtImportKeyTaBridgeData_clicked()
{
...
void CJackStock::on_pushButtonReqCompanyHistory_clicked()
{
